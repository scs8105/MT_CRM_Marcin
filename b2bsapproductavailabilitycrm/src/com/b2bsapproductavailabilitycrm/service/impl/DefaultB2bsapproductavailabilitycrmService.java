...
public class DefaultB2bsapproductavailabilitycrmService implements B2bsapproductavailabilitycrmService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultB2bsapproductavailabilitycrmService.class);
	...
	{
		return DefaultB2bsapproductavailabilitycrmService.class.getResourceAsStream("/b2bsapproductavailabilitycrm/sap-hybris-platform.png");
	}
