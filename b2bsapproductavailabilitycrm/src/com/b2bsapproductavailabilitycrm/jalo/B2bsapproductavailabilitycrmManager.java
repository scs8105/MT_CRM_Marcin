 ...
 */
package com.b2bsapproductavailabilitycrm.jalo;
...
/**
 * This is the extension manager of the B2bsapproductavailabilitycrm extension.
 */
public class B2bsapproductavailabilitycrmManager extends GeneratedB2bsapproductavailabilitycrmManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(B2bsapproductavailabilitycrmManager.class);
	 ...
	 */
	public static B2bsapproductavailabilitycrmManager getInstance()
	{
		return (B2bsapproductavailabilitycrmManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bsapproductavailabilitycrmConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bsapproductavailabilitycrmManager() // NOPMD 
	{
		LOG.debug("constructor of B2bsapproductavailabilitycrmManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of B2bsapproductavailabilitycrmManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of B2bsapproductavailabilitycrmManager called, current tenant: {}", getTenant().getTenantID());
	}
