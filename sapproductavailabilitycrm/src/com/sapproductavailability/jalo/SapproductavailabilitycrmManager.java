 ...
 */
package com.sapproductavailability.jalo;
...
/**
 * This is the extension manager of the Sapproductavailabilitycrm extension.
 */
public class SapproductavailabilitycrmManager extends GeneratedSapproductavailabilitycrmManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapproductavailabilitycrmManager.class);
	 ...
	 */
	public static SapproductavailabilitycrmManager getInstance()
	{
		return (SapproductavailabilitycrmManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductavailabilitycrmConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductavailabilitycrmManager() // NOPMD 
	{
		LOG.debug("constructor of SapproductavailabilitycrmManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SapproductavailabilitycrmManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapproductavailabilitycrmManager called, current tenant: {}", getTenant().getTenantID());
	}
