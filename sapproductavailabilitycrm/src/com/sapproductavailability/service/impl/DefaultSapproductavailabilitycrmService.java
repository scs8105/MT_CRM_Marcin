...
public class DefaultSapproductavailabilitycrmService implements SapproductavailabilitycrmService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapproductavailabilitycrmService.class);
	...
	{
		return DefaultSapproductavailabilitycrmService.class.getResourceAsStream("/sapproductavailabilitycrm/sap-hybris-platform.png");
	}
