...
/**
 * This is the extension manager of the Sapcrmcustomerb2c extension.
 */
public class Sapcrmcustomerb2cManager extends GeneratedSapcrmcustomerb2cManager
{
   /** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
   private static final Logger LOG = Logger.getLogger(Sapcrmcustomerb2cManager.class.getName());
    ...
    */
   public static Sapcrmcustomerb2cManager getInstance()
   {
      return (Sapcrmcustomerb2cManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
            .getExtension(Sapcrmcustomerb2cConstants.EXTENSIONNAME);
   }
   ...
   public void init()
   {
      ...
      {
         LOG.debug("init() of Sapcrmcustomerb2cManager called. " + getTenant().getTenantID());
      }
   }
   ...
   public void destroy()
   {
      if (LOG.isDebugEnabled())
      {
         LOG.debug("destroy() of Sapcrmcustomerb2cManager called, current tenant: " + getTenant().getTenantID());
      }
   }
