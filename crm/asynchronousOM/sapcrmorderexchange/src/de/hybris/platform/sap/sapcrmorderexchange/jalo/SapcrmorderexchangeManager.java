 ...
 * /
 */
package de.hybris.platform.sap.sapcrmorderexchange.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.sap.sapcrmorderexchange.constants.SapcrmorderexchangeConstants;
...
/**
 * This is the extension manager of the Crmorderexchange extension.
 */
public class SapcrmorderexchangeManager extends GeneratedSapcrmorderexchangeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmorderexchangeManager.class.getName());
	 ...
	 */
	public static SapcrmorderexchangeManager getInstance()
	{
		return (SapcrmorderexchangeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrmorderexchangeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmorderexchangeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CrmorderexchangeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CrmorderexchangeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CrmorderexchangeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
