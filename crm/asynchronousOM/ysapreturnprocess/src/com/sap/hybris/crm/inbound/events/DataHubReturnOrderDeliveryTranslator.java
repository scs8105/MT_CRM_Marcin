...
public class DataHubReturnOrderDeliveryTranslator extends AbstractSpecialValueTranslator {
    ...
    public DataHubReturnOrderDeliveryTranslator() {
    ...
    public void performImport(final String delivInfo, final Item processedItem) throws ImpExException {
        ...
        getInboundHelper().processOrderDeliveryNotififcationFromHub(orderCode, delivInfo);
    }
