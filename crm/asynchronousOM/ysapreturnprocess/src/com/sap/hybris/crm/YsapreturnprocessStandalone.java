 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.YsapreturnprocessStandalone().run();"
 ...
 */
public class YsapreturnprocessStandalone {
    /**
     * Edit the local|project.properties to change logging behavior (properties
     * log4j.*).
     */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(YsapreturnprocessStandalone.class.getName());
    ...
    public static void main(final String[] args) {
        new YsapreturnprocessStandalone().run();
    }
