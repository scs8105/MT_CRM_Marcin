 ...
 * /
 */
package de.hybris.platform.sap.sapcrmorderexchangeb2b;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new de.hybris.platform.sap.sapcrmorderexchangeb2b.Sapcrmorderexchangeb2bStandalone().run();"
 ...
 */
public class Sapcrmorderexchangeb2bStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new Sapcrmorderexchangeb2bStandalone().run();
    }
