...
<div class="account-orderdetail account-consignment">
	<div class="well well-quinary well-xs">
		<div class="well-headline">
			<spring:theme code="text.account.businessagreement.dunning" />
		</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-7 col-no-padding">
				<div class="row">
					...
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 ">
						<div class="businessAgreementDetailHeader">
							<spring:theme
								code="text.account.businessagreement.dunningrecipient" />
						</div>
						<div class="item-value"></div>
					</div>
					<div class="col-xs-7 col-sm-7  col-md-7 col-lg-7">

						<div class="">${businessAgreementDetailsData.dunningRecipientId}</div>
						<div class="item-value"></div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-7 col-sm-7  col-md-7 col-lg-7">
						...
						<div class="">${businessAgreementDetailsData.dunningDesc}</div>
						<div class="item-value"></div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-xs-7 col-sm-7  col-md-7 col-lg-7">
						...
						<div class="">${businessAgreementDetailsData.dunningShipControl}</div>
						<div class="item-value"></div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 ">
						...
						<div class="">
							<common:agreementaddressItem
								address="${businessAgreementDetailsData.dunningAddress}" />
						</div>
						<div class="item-value"></div>
						<div class="item-value"></div>
					</div>
