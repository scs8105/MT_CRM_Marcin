 ...
 * /
 */
package com.sap.hybris.crm.core.setup;
 ...
 *
 */
@SystemSetup(extension = "sapservicecontractaddon")
public class ServiceContractAddonSystemSetup extends DefaultAddOnSystemSetupSupport {
    ...
    public static final String DATA_IMPORT_FOLDER = "sapservicecontractaddon";
    ...
    protected void importContentCatalog(final SystemSetupContext context, final String importDirectory,
        ...
        importImpexFile(context, importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-content.impex",
                false);
        importImpexFile(context, importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-mobile-content.impex",
                false);
        importImpexFile(context, importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/email-content.impex",
                false);

        importImpexFile(context, importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-addon-extra.impex",
                false);
        ...
        importImpexFile(context, importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-content_zh.impex",
                false);
        importImpexFile(context, importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-content_zh_CN.impex",
                false);
        ...
        importImpexFile(context,
                importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-responsive-content_en.impex", false);
        importImpexFile(context,
                importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-responsive-content_hi.impex", false);
        importImpexFile(context,
                importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-responsive-content_ja.impex", false);
        importImpexFile(context,
                importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-responsive-content_ru.impex", false);
        importImpexFile(context,
                importRoot + CONTENT_CATALOG + catalogName + "ContentCatalog/cms-responsive-content_zh.impex", false);
        importImpexFile(context,
