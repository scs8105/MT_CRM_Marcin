 ...
 * /
 */
package com.sap.hybris.crm.sapcrmpricing.jalo;
...
/**
 * This is the extension manager of the Sapcrmpricing extension.
 */
public class SapcrmpricingManager extends GeneratedSapcrmpricingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmpricingManager.class.getName());
	 ...
	 */
	public static SapcrmpricingManager getInstance()
	{
		return (SapcrmpricingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrmpricingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmpricingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrmpricingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrmpricingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrmpricingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
