...
/**
 * This is the extension manager of the Sapcrmpricingbol extension.
 */
public class SapcrmpricingbolManager extends GeneratedSapcrmpricingbolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmpricingbolManager.class.getName());
	 ...
	 */
	public static SapcrmpricingbolManager getInstance()
	{
		return (SapcrmpricingbolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrmpricingbolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmpricingbolManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrmpricingbolManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrmpricingbolManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrmpricingbolManager called, current tenant: " + getTenant().getTenantID());
		}
	}
