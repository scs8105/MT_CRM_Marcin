...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_SAPConfiguration_sappricing_RFCDestination();
			
				single_createattr_SAPConfiguration_sapcrmpricingprocedure();
			

	}

	
	public void single_createattr_SAPConfiguration_sappricing_RFCDestination() throws JaloBusinessException
	{
	...
	public void single_createattr_SAPConfiguration_sapcrmpricingprocedure() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_SAPConfiguration_sappricing_RFCDestination();
		
			single_setAttributeProperties_SAPConfiguration_sapcrmpricingprocedure();
		
	}


		
						public void single_setAttributeProperties_SAPConfiguration_sappricing_RFCDestination() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_SAPConfiguration_sapcrmpricingprocedure() throws JaloBusinessException
						{
