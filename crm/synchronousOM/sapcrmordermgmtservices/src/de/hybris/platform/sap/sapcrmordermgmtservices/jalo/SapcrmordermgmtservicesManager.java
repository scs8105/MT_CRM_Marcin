 ...
 * /
 */
package de.hybris.platform.sap.sapcrmordermgmtservices.jalo;
...
import de.hybris.platform.sap.sapcrmordermgmtservices.constants.SapcrmordermgmtservicesConstants;



/**
 * This is the extension manager of the Sapcrmordermgmtservices extension.
 */
public class SapcrmordermgmtservicesManager extends GeneratedSapcrmordermgmtservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmordermgmtservicesManager.class.getName());
	 ...
	 */
	public static SapcrmordermgmtservicesManager getInstance()
	{
		return (SapcrmordermgmtservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrmordermgmtservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmordermgmtservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrmordermgmtservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrmordermgmtservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrmordermgmtservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
