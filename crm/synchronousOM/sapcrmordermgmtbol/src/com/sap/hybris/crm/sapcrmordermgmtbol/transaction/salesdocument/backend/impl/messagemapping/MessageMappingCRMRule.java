 ...
 * @see MessageMappingCRMRulesParserImpl
 */
public class MessageMappingCRMRule {

    /**
     * Constructor
     */
    public MessageMappingCRMRule() {
        pattern = new Pattern();
        result = new Result();
    }
     ...
     * @param result
     */
    public MessageMappingCRMRule(final Pattern pattern, final Result result) {
    ...
    static public class Pattern {
        ...
        /**
         * Pattern which indicates that rule should apply for any value in this
         * attribute
         */
         ...
         * <ol>
         * <li>More the number of attributes are defined then bigger is the
         * degree;
         * <li>Left attribute (e.g VAR1} has greater degree as the right one
         * (e.g. VAR4)
         * <li>Number of attributes has absolute priority over left to right
         * order.
         * </ol>
         */
        int attrDegree;
         ...
         * @param beV4
         */
        public Pattern(final String beClass, final String beNumber, final String beSeverity, final String beV1,
                final String beV2, final String beV3, final String beV4) {
         ...
         * Adjust the field:
         * <ul>
         * <li>maps all forms of string containing one star '*' to null. Null
         * mean any value.
        ...
        final static protected String agjustField(String value) {
            if (value == null) {
                ...
                if (tempValue.equals(ANY_PATTERN)) {
                    return null;
                } else {
                    return tempValue;
                }
        ...
        private boolean checkBeDetails(final Pattern o) {
            return equalsField(beClass, o.beClass) && equalsField(beNumber, o.beNumber)
                    && equalsField(beSeverity, o.beSeverity);
        }
        ...
        public String toString() {
            return MessageFormat.format("{0}/{1}/{2}/({3},{4},{5},{6}) ",
                    new Object[] { beClass, beNumber, beSeverity, beVars[0], beVars[1], beVars[2], beVars[3] });
        }

        /**
         * Does a pattern match a specific message, identified by its
         * attributes?
         *
         * @param beClass
         * @param beNumber
        ...
        /**
         * Does a pattern match a specific message, only considering the static
         * attributes?
         *
         * @param beClass
         * @param beNumber
        ...
        public boolean matchVARS(final String var1, final String var2, final String var3, final String var4) {
            return matchField(this.beVars[0], var1) && matchField(this.beVars[1], var2)
                    && matchField(this.beVars[2], var3) && matchField(this.beVars[3], var4);
        }
        ...
        protected void calculateDegree() {
            attrDegree = 0;
            for (int i = 0; i < VAR_ARRAY_SIZE; ++i) { // from 0 to
                if (beVars[i] != null) {
    ...
    static public class Result {
        ...
        /**
         * ID of callback which can be used to change the message on application
         * side.
         *
         ...
         * @param processStep
         */
        public Result(final Character severity, final String resourceKey, final String callbackId,
        ...
        public boolean equals(final Object obj) {
            ...
            return equalsField(hide, o.hide) && equalsField(severity, o.severity)
                    && equalsField(resourceKey, o.resourceKey);
        }
        ...
        public String toString() {
            if (isHide()) {
                ...
                return MessageFormat.format("{0}/{1}", new Object[] { severity, resourceKey });
            }
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof MessageMappingCRMRule)) {
            return false; // quick check by hashCode
        }

        final MessageMappingCRMRule o = (MessageMappingCRMRule) obj;
    ...
    @Override
    public String toString() {
        return MessageFormat.format(" {0} -> {1}", new Object[] { pattern, result });
    }
