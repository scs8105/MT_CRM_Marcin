 ...
 * This class consists only of static method. Each of theses methods wraps the function module. The purpose of this
 * class is to maintain only one implementation of the logic necessary to call this function module via jco using data
 * provided by Java objects. <br>
 *
 * @version 1.0
 */
public interface SetStrategy
{
	...
	/**
	 * Strategy for CRM_LORD_SET, all values found in the provided sales document are written to the backend system. If
	 ...
	 */
	public BackendCallResult execute(BackendState salesDocR3Lrd, SalesDocument salesDoc, Map<String, Item> itemsCRMState,
