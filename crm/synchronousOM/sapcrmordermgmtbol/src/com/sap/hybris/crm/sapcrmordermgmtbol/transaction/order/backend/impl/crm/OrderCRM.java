...
/**
 * Back end Object representing an CRM Order document used in checkout (different connection compared to history orders)
 */
@BackendType("CRM")
public class OrderCRM extends OrderBaseCRM implements OrderBackend
{
