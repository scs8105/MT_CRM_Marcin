...
/**
 * This is the extension manager of the Sapcrmordermgmtbol extension.
 */
public class SapcrmordermgmtbolManager extends GeneratedSapcrmordermgmtbolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmordermgmtbolManager.class.getName());
	 ...
	 */
	public static SapcrmordermgmtbolManager getInstance()
	{
		return (SapcrmordermgmtbolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapcrmordermgmtbolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmordermgmtbolManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrmordermgmtbolManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrmordermgmtbolManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrmordermgmtbolManager called, current tenant: " + getTenant().getTenantID());
		}
	}
