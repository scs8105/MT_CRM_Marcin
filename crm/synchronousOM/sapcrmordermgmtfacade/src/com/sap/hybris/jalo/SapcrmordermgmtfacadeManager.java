...
import com.sap.hybris.constants.SapcrmordermgmtfacadeConstants;



/**
 * This is the extension manager of the Sapcrmordermgmtfacade extension.
 */
public class SapcrmordermgmtfacadeManager extends GeneratedSapcrmordermgmtfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmordermgmtfacadeManager.class.getName());
	 ...
	 */
	public static SapcrmordermgmtfacadeManager getInstance()
	{
		return (SapcrmordermgmtfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrmordermgmtfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmordermgmtfacadeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrmordermgmtfacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrmordermgmtfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrmordermgmtfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
