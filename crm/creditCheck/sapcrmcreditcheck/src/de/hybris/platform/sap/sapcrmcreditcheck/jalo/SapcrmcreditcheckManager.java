...
/**
 * This is the extension manager of the Sapcrmcreditcheck extension.
 */
public class SapcrmcreditcheckManager extends GeneratedSapcrmcreditcheckManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmcreditcheckManager.class.getName());
	 ...
	 */
	public static SapcrmcreditcheckManager getInstance()
	{
		return (SapcrmcreditcheckManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrmcreditcheckConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmcreditcheckManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrmcreditcheckManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrmcreditcheckManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrmcreditcheckManager called, current tenant: " + getTenant().getTenantID());
		}
	}
