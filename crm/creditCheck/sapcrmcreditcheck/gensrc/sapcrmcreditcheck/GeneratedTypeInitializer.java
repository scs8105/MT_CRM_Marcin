...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_SAPConfiguration_sapcreditcheckavailability_RFCDestination();
			

	}

	
	public void single_createattr_SAPConfiguration_sapcreditcheckavailability_RFCDestination() throws JaloBusinessException
	{
				...
				createPropertyAttribute(
					"SAPConfiguration", 
					"sapcreditcheckavailability_RFCDestination",  
					null,
					"SAPRFCDestination",
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_SAPConfiguration_sapcreditcheckavailability_RFCDestination();
		
	}


		
						public void single_setAttributeProperties_SAPConfiguration_sapcreditcheckavailability_RFCDestination() throws JaloBusinessException
						{
