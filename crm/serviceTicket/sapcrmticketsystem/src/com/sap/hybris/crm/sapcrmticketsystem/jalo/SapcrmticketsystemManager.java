...
import com.sap.hybris.crm.sapcrmticketsystem.jalo.GeneratedSapcrmticketsystemManager;



/**
 * This is the extension manager of the Sapcrmticketsystem extension.
 */
public class SapcrmticketsystemManager extends GeneratedSapcrmticketsystemManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrmticketsystemManager.class.getName());
	 ...
	 */
	public static SapcrmticketsystemManager getInstance()
	{
		return (SapcrmticketsystemManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrmticketsystemConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrmticketsystemManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrmticketsystemManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrmticketsystemManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrmticketsystemManager called, current tenant: " + getTenant().getTenantID());
		}
	}
