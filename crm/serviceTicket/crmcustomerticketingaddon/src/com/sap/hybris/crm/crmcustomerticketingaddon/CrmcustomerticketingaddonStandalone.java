 ...
 * /
 */
package com.sap.hybris.crm.crmcustomerticketingaddon;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.crmcustomerticketingaddon.CrmcustomerticketingaddonStandalone().run();"
 ...
 */
public class CrmcustomerticketingaddonStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new CrmcustomerticketingaddonStandalone().run();
    }
