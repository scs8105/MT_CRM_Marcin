 ...
 * /
 */
package com.sap.hybris.crm.sapcrmcategoryschema;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapcrmcategoryschema.SapcrmcategoryschemaStandalone().run();"
 ...
 */
public class SapcrmcategoryschemaStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapcrmcategoryschemaStandalone().run();
    }
