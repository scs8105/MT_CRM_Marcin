 ...
 * /
 */
package com.sap.hybris.productregistrationservices;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.productregistrationservices.ProductregistrationservicesStandalone().run();"
 ...
 */
public class ProductregistrationservicesStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new ProductregistrationservicesStandalone().run();
    }
