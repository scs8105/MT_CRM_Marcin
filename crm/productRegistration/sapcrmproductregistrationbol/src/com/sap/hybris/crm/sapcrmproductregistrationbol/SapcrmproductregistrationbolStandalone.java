 ...
 * /
 */
package com.sap.hybris.crm.sapcrmproductregistrationbol;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapcrmproductregistraionbol.SapcrmproductregistrationbolStandalone().run();"
 ...
 */
public class SapcrmproductregistrationbolStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapcrmproductregistrationbolStandalone().run();
    }
