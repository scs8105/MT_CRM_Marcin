 ...
 * /
 */
package com.sap.hybris.productregistrationaddon;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.productregistrationaddon.ProductregistrationaddonStandalone().run();"
 ...
 */
public class ProductregistrationaddonStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new ProductregistrationaddonStandalone().run();
    }
