...
package productregistrationaddon;
...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"SimpleCMSComponent",
			de.hybris.platform.productregistrationaddon.jalo.components.ProductRegistrationComponent.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_SAPConfiguration_productRegistrationRfcDestination();
			

	}

	
	public void single_createattr_SAPConfiguration_productRegistrationRfcDestination() throws JaloBusinessException
	{
				...
				createPropertyAttribute(
					"SAPConfiguration", 
					"productRegistrationRfcDestination",  
					null,
					"SAPRFCDestination",
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_SAPConfiguration_productRegistrationRfcDestination();
		
	}


		
						public void single_setAttributeProperties_SAPConfiguration_productRegistrationRfcDestination() throws JaloBusinessException
						{
