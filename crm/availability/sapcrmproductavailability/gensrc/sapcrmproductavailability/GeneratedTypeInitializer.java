...
package sapcrmproductavailability;
...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_SAPConfiguration_sapproductavailability_RFCDestination();
			

	}

	
	public void single_createattr_SAPConfiguration_sapproductavailability_RFCDestination() throws JaloBusinessException
	{
				...
				createPropertyAttribute(
					"SAPConfiguration", 
					"sapproductavailability_RFCDestination",  
					null,
					"SAPRFCDestination",
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_SAPConfiguration_sapproductavailability_RFCDestination();
		
	}


		
						public void single_setAttributeProperties_SAPConfiguration_sapproductavailability_RFCDestination() throws JaloBusinessException
						{
