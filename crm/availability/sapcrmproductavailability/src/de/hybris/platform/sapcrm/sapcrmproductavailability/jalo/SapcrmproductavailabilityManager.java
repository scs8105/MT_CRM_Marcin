...
/**
 * This is the extension manager of the Sapcrmproductavailability extension.
 */
public class SapcrmproductavailabilityManager extends GeneratedSapcrmproductavailabilityManager {
    /**
     * Edit the local|project.properties to change logging behavior (properties
     * 'log4j.*').
     */
    private static final Logger LOG = Logger.getLogger(SapcrmproductavailabilityManager.class.getName());
     ...
     */
    public static SapcrmproductavailabilityManager getInstance() {
        return (SapcrmproductavailabilityManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(SapcrmproductavailabilityConstants.EXTENSIONNAME);
    }
     ...
     */
    public SapcrmproductavailabilityManager() // NOPMD
    {
        if (LOG.isDebugEnabled()) {
            LOG.debug("constructor of SapcrmproductavailabilityManager called.");
        }
    }
    ...
    public void init() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("init() of SapcrmproductavailabilityManager called. " + getTenant().getTenantID());
        }
    }
    ...
    public void destroy() {
        if (LOG.isDebugEnabled()) {
            LOG.debug("destroy() of SapcrmproductavailabilityManager called, current tenant: "
