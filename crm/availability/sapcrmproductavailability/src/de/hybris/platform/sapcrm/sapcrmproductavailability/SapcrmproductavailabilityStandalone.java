 ...
 * /
 */
package de.hybris.platform.sapcrm.sapcrmproductavailability;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new de.hybris.platform.sapcrm.sapcrmproductavailability.SapcrmproductavailabilityStandalone().run();"
 ...
 */
public class SapcrmproductavailabilityStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapcrmproductavailabilityStandalone().run();
    }
