 ...
 * /
 */
package com.sap.hybris.crm.sapserviceorderservices;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapserviceorderservices.SapserviceorderservicesStandalone().run();"
 ...
 */
public class SapserviceorderservicesStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapserviceorderservicesStandalone().run();
    }
