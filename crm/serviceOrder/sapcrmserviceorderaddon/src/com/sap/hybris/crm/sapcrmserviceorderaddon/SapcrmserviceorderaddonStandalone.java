 ...
 * /
 */
package com.sap.hybris.crm.sapcrmserviceorderaddon;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapcrmserviceorderaddon.SapcrmserviceorderaddonStandalone().run();"
 ...
 */
public class SapcrmserviceorderaddonStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapcrmserviceorderaddonStandalone().run();
    }
