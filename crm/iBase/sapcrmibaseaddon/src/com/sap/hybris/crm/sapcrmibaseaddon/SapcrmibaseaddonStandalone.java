 ...
 * /
 */
package com.sap.hybris.crm.sapcrmibaseaddon;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapcrmibaseaddon.SapcrmibaseaddonStandalone().run();"
 ...
 */
public class SapcrmibaseaddonStandalone {
    private static final Logger LOG = Logger.getLogger(SapcrmibaseaddonStandalone.class);
    ...
    public static void main(final String[] args) {
        new SapcrmibaseaddonStandalone().run();
    }
