 ...
 * /
 */
package com.sap.hybris.crm.sapcrmibasefacades;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapcrmibasefacades.SapcrmibasefacadesStandalone().run();"
 ...
 */
public class SapcrmibasefacadesStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapcrmibasefacadesStandalone().run();
    }
