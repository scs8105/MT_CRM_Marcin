 ...
 * /
 */
package com.sap.hybris.crm.sapcrmibasecore;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapcrmibasecore.SapcrmibasecoreStandalone().run();"
 ...
 */
public class SapcrmibasecoreStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapcrmibasecoreStandalone().run();
    }
