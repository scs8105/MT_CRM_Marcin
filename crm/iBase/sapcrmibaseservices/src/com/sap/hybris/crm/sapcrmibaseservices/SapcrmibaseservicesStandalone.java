 ...
 * /
 */
package com.sap.hybris.crm.sapcrmibaseservices;
 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.sap.hybris.crm.sapcrmibaseservices.SapcrmibaseservicesStandalone().run();"
 ...
 */
public class SapcrmibaseservicesStandalone {
    /**
    ...
    public static void main(final String[] args) {
        new SapcrmibaseservicesStandalone().run();
    }
