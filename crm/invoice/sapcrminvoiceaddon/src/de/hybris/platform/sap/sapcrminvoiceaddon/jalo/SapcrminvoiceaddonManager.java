...
/**
 * This is the extension manager of the Sapcrminvoiceaddon extension.
 */
public class SapcrminvoiceaddonManager extends GeneratedSapcrminvoiceaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcrminvoiceaddonManager.class.getName());
	 ...
	 */
	public static SapcrminvoiceaddonManager getInstance()
	{
		return (SapcrminvoiceaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcrminvoiceaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcrminvoiceaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcrminvoiceaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcrminvoiceaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcrminvoiceaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
